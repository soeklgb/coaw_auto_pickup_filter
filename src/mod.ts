...
import {} from "maginai-game-types";
            ...
            const filter = (() => {
              if (kantei) {
                if (isSkillBook) {
                  ...
                  } else if (this.kanteiFilter.has("すべて")) {
                    return this.kanteiFilter.get("すべて");
                  } else if (this.askillBookFilter.has(name)) {
...
const autoPickupFilter = new AutoPickupFilter();
autoPickupFilter.init();
